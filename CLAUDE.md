...
docs/historico/     Relatórios históricos de auditoria/execução — leitura, não procedimento
```
...
- `docs/historico/` — relatórios históricos de auditorias/estabilização; contexto, não procedimento.
