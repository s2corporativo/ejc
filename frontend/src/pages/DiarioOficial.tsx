      ...
      <section>
        ...
        <form onSubmit={adicionarKeyword} className="flex gap-2 mb-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-1 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors"
          >
