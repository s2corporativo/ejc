  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-stone-950">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-stone-950/40 border-b border-warn-900/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-serif font-bold text-warn-500">
                EJC v6.0
              </h1>
          ...
          <div className="flex items-center space-x-6">
            <button className="text-stone-400 hover:text-warn-500 transition-colors text-sm font-medium">
              Notificações
            </button>
            <button className="text-stone-400 hover:text-warn-500 transition-colors text-sm font-medium">
              Configurações
            </button>
            <div className="w-10 h-10 bg-gradient-to-br from-warn-600 to-warn-800 rounded-full flex items-center justify-center text-white font-bold">
              DC
            </div>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-stone-400 text-lg">
            Seu ecossistema jurídico soberano está operacional
          </p>
        </div>
          ...
          <div className="space-y-8">
                ...
                >
                  ...
                  <div className="relative">
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <span className="text-xs font-bold text-green-400 bg-green-900/20 px-3 py-1 rounded-full">
                        {kpi.trend}
                      </span>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 rounded-2xl bg-gradient-to-br from-stone-800/50 to-stone-900/50 border border-warn-900/20 p-8 backdrop-blur-xl">
                <h3 className="text-xl font-serif font-bold text-warn-400 mb-6">
                  🔥 Foco no Hoje
                </h3>
                <div className="space-y-4">
                  {[
                    {
                      title: "Réplica - Caso #1029",
                      date: "Hoje",
                      priority: "high",
                    },
                    {
                    ...
                    <div
                      key={i}
                      className="flex items-center justify-between p-4 bg-stone-700/30 rounded-lg hover:bg-stone-700/50 transition-colors"
                    >
                      <div>
                      ...
                      <div
                        className={`w-3 h-3 rounded-full ${item.priority === "high" ? "bg-danger-500" : "bg-warn-500"}`}
                      />
                    </div>
                  ))}
                </div>
              ...
              <div className="rounded-2xl bg-gradient-to-br from-warn-900/20 to-stone-900/50 border border-warn-600/30 p-8 backdrop-blur-xl">
                ...
                <div className="space-y-3">
                  <div className="p-4 bg-warn-900/20 rounded-lg border border-warn-600/20">
                    <p className="text-sm text-warn-200 mb-2">
                      Alvará Expedido
                    </p>
        ...
        {activeTab === "intelligence" && (
          <div className="rounded-2xl bg-gradient-to-br from-stone-800/50 to-stone-900/50 border border-warn-900/20 p-8 backdrop-blur-xl">
            <h3 className="text-2xl font-serif font-bold text-warn-400 mb-6">
              🧠 Cérebro EJC (Ollama Local)
            </h3>
            <p className="text-stone-300 mb-6">
              Status:{" "}
              <span className="text-green-400 font-bold">
                ✓ Operacional (100% Soberano)
              </span>
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="p-6 bg-stone-700/20 rounded-lg">
                <p className="text-warn-400 font-bold mb-2">
        ...
        {activeTab === "audit" && (
          <div className="rounded-2xl bg-gradient-to-br from-stone-800/50 to-stone-900/50 border border-warn-900/20 p-8 backdrop-blur-xl">
            ...
            <p className="text-stone-300 mb-6">
              Carregue uma proposta de concorrente para análise automática de
              falhas técnicas e equivalência.
            </p>
      ...
      <footer className="border-t border-warn-900/10 mt-16 py-8 text-center text-stone-500 text-sm">
        <p>
          EJC v6.0 — Sovereign Diamond © 2026 | Soberania Tecnológica & Luxo
          Jurídico
        </p>
      </footer>
    </div>
