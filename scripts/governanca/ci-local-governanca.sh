...
ROOT_OF_TRUST='scripts/(ci-local\.sh|ci-fallback[^/]*\.sh|ci-worker-isolation\.sh|github-app-auth\.sh|ci_evidence\.py|ci_activation_journal\.py|governanca/(branch-protection|branch-protection-bootstrap|ci-local-governanca)\.sh)'
