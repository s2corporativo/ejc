...
EJC_CI_WORKER_USER="$WORKER_USER" EJC_CI_WORKER_ROOT="$WORKER_ROOT" EJC_FALLBACK_APP_PRIVATE_KEY_FILE="$APP_KEY_FILE" EJC_CI_STATE_ROOT="$CACHE_ROOT" bash scripts/ci-worker-isolation.sh preflight \
