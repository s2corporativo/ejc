...
| V2-5.1 | Primeira leva (6 de ~50 descobertas — auditoria amostrou 15 em 3 áreas, achei o padrão em ~13 áreas): form-runner genérico (`CalculadorasJuridicas.tsx`) + config declarativa extensível, embutido em "Mais Ferramentas". Restante entra só como nova entrada na config `[ALTO — maior ganho rápido]` | F3 | #1272 | em-andamento | — | 2026-08-24 |
