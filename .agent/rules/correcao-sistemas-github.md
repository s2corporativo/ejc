...
4. Pesquise backend, frontend, rotas, services, models, migrations, scripts e workflows existentes antes de alterar.
5. Corrija a causa do defeito com a menor mudanca suficiente.
6. Rode a validacao definida no repositorio.
...
Informe causa, arquivos alterados, testes/validacoes, riscos restantes e rollback quando aplicavel.
