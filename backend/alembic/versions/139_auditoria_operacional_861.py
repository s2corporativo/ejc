"""139 — auditoria operacional: prazos, financeiro, portal e assinaturas.
...
Revision ID: 139_auditoria_operacional_861
...
revision = "139_auditoria_operacional_861"
...
def _assert_sem_evidencia_nova() -> None:
    ...
    if usados:
        raise RuntimeError(
            "Downgrade 139 recusado: há evidência operacional não representável "
