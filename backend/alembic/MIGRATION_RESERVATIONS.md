...
| 138_consolida_fontes_ingestao | 132_processo_eletronico_mni | main | [#786](https://github.com/s2corporativo/ejc/pull/786) | Claude Code | Mesclada | Onda 2 — consolidação de fontes de ingestão. **Head canônico atual da `main`.** Números 133–137 foram pulados/reservados por frentes concorrentes; qualquer nova migration deve partir da 138 e reconciliar reservas abertas antes de escolher numeração. |
