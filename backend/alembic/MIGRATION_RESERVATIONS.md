...
| 127_documento_publicacao_explicita | 126_case_status_quatro_estados | claude/ejc-audit-redesign-7i7idc | (em desenvolvimento) | Claude Code | Reservada | Fase 0: corrige vazamento de sigilo do portal — documentos publicados por omissão. Default confidencialidade "normal"→"confidencial"; usuário marca EXPLICITAMENTE para publicar (Auditoria 2026-07). |
