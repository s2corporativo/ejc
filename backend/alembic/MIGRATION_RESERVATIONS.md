...
**Head esperado nesta árvore após as migrations do branch:** `162_runtime_tables_alembic`
...
| `162_runtime_tables_alembic` | `161_fee_estornos` | **Em PR** | Adota tabelas de estado/cache antes criadas em runtime e adiciona dois índices FK priorizados; downgrade preserva tabelas/dados preexistentes. |
...
- Nesta árvore, o head efetivo é `162_runtime_tables_alembic` e o próximo prefixo livre é `163`.
