...
**Head esperado nesta árvore após as migrations do branch:** `162_manus_tasks`
...
| `162_manus_tasks` | `161_fee_estornos` | **Em PR** | Estado auditável das análises assíncronas externas via Manus API; tabela aditiva e desligada por padrão. |
...
- Nesta árvore da release, o head efetivo é `162_manus_tasks` e o próximo prefixo livre é `163`.
