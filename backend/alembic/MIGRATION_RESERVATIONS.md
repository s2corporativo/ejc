...
| 140_preliminares_fundacao_schema | 138_consolida_fontes_ingestao | feat/964-preliminares-schema-139 | [#965](https://github.com/s2corporativo/ejc/pull/965) | ChatGPT | Em PR | **Reserva canônica ativa.** Fase 1 da fusão física Sala Jurídica + Raio-X: somente quatro tabelas unificadas novas; sem backfill, dual-write, ALTER ou DROP nas tabelas legadas. As frentes #968/#969/#970 devem aguardar a integração desta revisão antes de reservar migrations subsequentes. |
