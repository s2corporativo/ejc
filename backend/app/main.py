...
app.include_router(honorarios_calc.router, prefix=API)  # shim compat. /honorarios-calc (redirect 308)
app.include_router(exito_rateio.router, prefix=API)  # shim compat. /honorarios-exito (redirect 308)
