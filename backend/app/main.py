...
from app.routers import teses_governanca  # migration 162
...
app.include_router(teses_governanca.router, prefix=API)  # migration 162 — pinned + fluxo de aprovação + fork + versões
