...
#
# Auth: require_roles(_EQUIPE) — mesma das demais ferramentas previdenciárias em
...
async def parecer_pdf(
    ...
    return {"download_url": f"/previdenciario/ferramentas/parecer/{arquivo_id}/download?t={token}"}
