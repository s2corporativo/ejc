...
async def _rl_manifesto_publico(request: Request) -> None:
    await consumir(
...
async def _rl_download_publico(request: Request) -> None:
    await consumir(
...
@router.get(
    ...
    include_in_schema=False,
    dependencies=[Depends(_rl_manifesto_publico)],
)
async def manifesto_publico(
    ...
    from app.services.data_room_public import abrir_manifesto
...
@router.get(
    ...
    include_in_schema=False,
    dependencies=[Depends(_rl_download_publico)],
)
async def download_publico(
    ...
    from app.services.data_room_public import headers_publicos, preparar_download
