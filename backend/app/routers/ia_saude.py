...
async def estado_operacional(
    ...
    return {
        "provedores": {
            ...
            "maritaca": {"configurado": bool(os.getenv("MARITACA_API_KEY")), "habilitado": _bool_env("MARITACA_ENABLED"), "modelo": os.getenv("MARITACA_MODEL_COMPLEXO", "sabia-4"), "nacional": True},
