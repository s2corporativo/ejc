...
# Honestidade epistêmica (auditoria 2026-07-15, relatório final do Núcleo Único
# de IA, seção 13, item 3): "Veredito IA" é nome de produto — `probabilidade_exito`
# NÃO é uma predição de LLM, é uma taxa estatística determinística (jurimetria
# sobre casos ENCERRADOS reais). Ver `metodo_probabilidade` no schema de resposta.
