...
_AREA_SKILLS = {
    ...
    "licitacoes": ["defesa-administrativa", "recurso-administrativo", "revisor-contratos"],
...
_REGRAS_DOCUMENTO = (
    ...
    _r("licitacao_contrato_administrativo", ("edital de licitacao", "pregao eletronico", "ata de registro de precos", "contrato administrativo", "nota de empenho", "sancao administrativa"), ("defesa-administrativa", "recurso-administrativo", "revisor-contratos"), "documentos", "licitacoes", "licitacoes e contratos", "administrativo", ("orgao", "edital", "processo", "objeto", "item", "prazo", "sancao", "contrato")),
    ...
    _r("inventario_sucessoes", ("inventario", "espolio", "herdeiros", "autor da heranca", "partilha", "testamento"), ("inventario-partilha", "raio-x-processual", "revisor-contratos"), "documentos", "sucessoes", "inventario e partilha", "inventario judicial ou extrajudicial", ("falecido", "herdeiros", "bens", "dividas", "testamento", "partilha")),
