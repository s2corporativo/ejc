...
def _instalar_wrappers() -> None:
    ...
    # Defesa em profundidade: mesmo que um chamador futuro contorne o detector
    # e invoque o escritor legado diretamente, o último passo de persistência
    # continua neutralizado enquanto #968 não fornecer termo inicial/regime
    # auditáveis e revisão humana.
