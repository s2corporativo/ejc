...
def _mod(
    ...
    *,
    ...
    return {
        ...
        "help_key": help_key or module_key,
    }
...
MODULE_REGISTRY: list[dict[str, Any]] = [
    ...
    _mod(
        ...
        responsavel_operacional="atendimento", help_key="atividades",
    ),
    _mod(
    ...
    _mod(
        ...
        responsavel_operacional="juridico", help_key="casos",
    ),
    _mod(
        ...
        responsavel_operacional="gestao", help_key="casos",
    ),
    _mod(
    ...
    _mod(
        ...
        responsavel_operacional="juridico", help_key="atividades",
    ),
    _mod(
    ...
    _mod(
        ...
        responsavel_operacional="juridico", help_key="inteligencia",
    ),
    _mod(
        ...
        usa_ia=True, responsavel_operacional="juridico", help_key="inteligencia",
    ),
    _mod(
...
def gerar_mapa_modulos(
    ...
    for item in MODULE_REGISTRY:
        ...
        help_key = str(item.get("help_key") or key)
        mapa.append({
            **item,
            "tem_manual": None if helps is None else help_key in helps,
            "precisa_documentacao": (
                None if helps is None else help_key not in helps
            ),
