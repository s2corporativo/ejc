...
MODULE_REGISTRY: list[dict[str, Any]] = [
    ...
    _mod(
        ...
        "Financeiro",
        "/financeiro",
        ["/api/financeiro", "/api/financeiro/consolidado", "/api/fees", "/api/despesas", "/api/pix"],
    ...
    _mod(
        ...
        ["/api/sociedade", "/api/office-contracts", "/api/partner-withdrawals"],
        perfis=PERFIS_GESTAO,
