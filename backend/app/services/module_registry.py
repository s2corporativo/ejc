...
MODULE_REGISTRY: list[dict[str, Any]] = [
    ...
    _mod(
        ...
        "Operação",
        "/clientes",
        ["/api/clients", "/api/dossie-cliente"],
    ...
    _mod(
        ...
        ["/api/atendimentos", "/api/mensagens", "/api/notifications"],
    ...
    _mod(
        ...
        "Jurídico",
        "/casos",
        ["/api/cases", "/api/processes", "/api/case-partes", "/api/caso-areas"],
    ...
    _mod(
        ...
        "Jurídico",
        "/prazos",
        ["/api/deadlines", "/api/suspensoes", "/api/calendar-feed"],
        perfis=PERFIS_JURIDICO + ["secretaria"],
    ...
    _mod(
        ...
        "Produção",
        "/pecas",
        ["/api/peca-geracao", "/api/pecas", "/api/legal-docs", "/api/templates"],
        perfis=PERFIS_JURIDICO,
    ...
    _mod(
        ...
        "Produção",
        "/checklists",
        ["/api/checklists", "/api/pending-items"],
        perfis=PERFIS_JURIDICO,
    ...
    _mod(
        ...
        "Financeiro",
        "/honorarios",
        ["/api/honorarios", "/api/honorarios-calc", "/api/honorarios-oab", "/api/exito-rateio"],
    ...
    _mod(
        ...
        "Financeiro",
        "/sociedade",
        ["/api/gestao-societaria", "/api/office-contracts", "/api/partner-withdrawals"],
        perfis=PERFIS_GESTAO,
    ...
    _mod(
        ...
        "Inteligência",
        "/ia",
        ["/api/ai", "/api/ai-core", "/api/ia-governanca", "/api/ia-saude", "/api/ai-tools", "/api/ai-skills"],
        perfis=PERFIS_JURIDICO,
    ...
    _mod(
        ...
        "Inteligência",
        "/inteligencia",
        ["/api/intelligence", "/api/cerebro", "/api/indice-risco", "/api/score-juridico"],
        perfis=PERFIS_JURIDICO,
    ...
    _mod(
        ...
        "Inteligência",
        "/ferramentas-ia",
        ["/api/ia-extra", "/api/ia-especializada", "/api/ia-defensiva", "/api/ia-adversarial", "/api/ia-citacoes"],
        perfis=PERFIS_JURIDICO,
    ...
    _mod(
        ...
        "Inteligência",
        "/conhecimento",
        ["/api/rag", "/api/rag-public", "/api/teses", "/api/teses-v4", "/api/sumulas", "/api/jurisprudencia-interna", "/api/jurisprudencia-externa"],
    ...
    _mod(
        ...
        "Inteligência",
        "/jurimetria",
        ["/api/jurimetria", "/api/jurimetria-extra", "/api/analytics"],
        perfis=PERFIS_JURIDICO,
    ...
    _mod(
        ...
        "Inteligência",
        "/victory-vault",
        ["/api/victory-vault", "/api/teses", "/api/provas"],
        perfis=PERFIS_JURIDICO,
    ...
    _mod(
        ...
        "Atendimento",
        "/whatsapp",
        ["/api/whatsapp", "/api/webhooks", "/api/evolution-webhook"],
        perfis=PERFIS_OPERACAO,
    ...
    _mod(
        ...
        "Administração",
        "/produtividade",
        ["/api/produtividade", "/api/timesheet", "/api/atividades"],
        perfis=PERFIS_GESTAO + ["advogado"],
