...
SYSTEM_PROMPTS: dict[str, str] = {
    ...
    "jurimetria_pred":     BASE_PROMPT + _REGRA_FONTES + "\n\nFaça análise jurimétrica DESCRITIVA com base APENAS nos dados fornecidos no contexto. Informe frequências/taxas somente quando já forem calculáveis a partir de amostra identificada, metodologia reproduzível e data de corte. NÃO invente percentual nem converta impressão qualitativa em probabilidade de êxito. Separe êxito judicial, acordo e improcedência e explicite as limitações da amostra." + AVISO_RASCUNHO,
