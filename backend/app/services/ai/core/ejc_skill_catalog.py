...
MODULE_METHODS: dict[str, str] = {
    ...
    "ajuizamento": "Conduza o ajuizamento sobre os dados já cadastrados do caso: classe e assuntos da TPU, jurisdição, competência, partes, advogados, petição e anexos. Aponte pendências do preflight, exija a revisão humana antes do protocolo e nunca declare protocolo sem número/recibo devolvido pelo tribunal.",
    "ajuizamento-perfis": "Trate o perfil de integração de cada tribunal: endpoint, versão, capacidades e checklist de homologação. Credencial entra só como referência ao Cofre; sem os quatro selos, o protocolo eletrônico permanece indisponível.",
