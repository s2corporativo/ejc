...
# REGISTRO ÚNICO de provedores de IA do EJC.
from __future__ import annotations

from app.core.config import get_settings

# Ordem canônica: local primeiro; entre externos, Maritaca antes do Groq.
# AI_PROVIDER_PRIORITY pode sobrepor a ordem, nunca a elegibilidade.
