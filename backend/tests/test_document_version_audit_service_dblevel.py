        ...
        async with Session() as db:
            ...
            db.add_all(
                [
                    ...
                    # Raiz legada sem versao_grupo_id.
                    _doc(legado, grupo_id=None, versao=1),
                    # Um slot de versão duplicado (duas v2).
                    ...
                    # Duas raízes no mesmo grupo, sem duplicar número.
                    _doc(multi, grupo_id=multi, versao=1),
                    _doc(multi_v2, grupo_id=multi, versao=2),
                    # Predecessor pertence a outro grupo.
                    ...
                    # Contexto client_id diverge dentro do grupo e da aresta predecessor.
            ...
            # Nenhum dado sintético sobrevive ao teste.
            await db.rollback()
