...
async def test_legenda_ia_sanitiza_pii_e_loga(monkeypatch):
    capturado = {}
    ...
    # PII mascarada ANTES de sair para o provedor (regra IA-01):
    ...
    # AILog gravado com a marca de PII removida:
