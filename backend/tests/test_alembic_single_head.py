...
HEAD_REVISION = "121_sala_analise_juridica"
...
def test_sala_analise_encadeia_apos_chunk_pagina():
    revision = _script_directory().get_revision("121_sala_analise_juridica")
