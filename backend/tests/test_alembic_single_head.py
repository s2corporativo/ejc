...
HEAD_REVISION = "142_preliminares_fundacao_schema"
...
def test_preliminares_fundacao_encadeia_apos_consolida_fontes_ingestao():
    revision = _script_directory().get_revision("142_preliminares_fundacao_schema")
