...
Testes sem rede/banco: verificam somente a decisão local dos ingestores e
impedem dois erros jurídicos simétricos — revogar o diploma atual porque sua
ementa menciona outra norma revogada, ou deixar passar ato cujo próprio título
traz marcador inequívoco de revogação.
"""
