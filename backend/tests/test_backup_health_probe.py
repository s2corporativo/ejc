...
AGORA = datetime(2026, 7, 21, 12, 0, tzinfo=timezone.utc)
...
def _estado(**overrides):
    data = {
        ...
        "last_status": "sucesso",
        "detalhes": [
            {"nome": "ejc_backup_20260721T050000Z_db.dump.enc"},
            {"nome": "ejc_backup_20260721T050000Z_uploads.tar.gz.enc"},
        ],
    }
    data.update(overrides)
    return data
...
def test_backup_saudavel_exige_banco_uploads_e_recencia():
