...
def test_conteudo_sanitizado_quando_captura_ligada(monkeypatch):
    # Sanitização reativada (LGPD): mesmo com captura ligada, o conteúdo é
    # mascarado antes de ir ao Langfuse (mesma barreira do gateway).
