...
async def test_upload_com_case_id_vincula_documento_ao_caso(monkeypatch):
    from app.core.database import AsyncSessionLocal
    from app.models.user import User, UserRole
    from app.models.document import Document
    import app.routers.documents as documents

    # Determinismo: sem libmagic (valida como PDF) e sem OCR real do PDF falso.
    ...
    async with AsyncSessionLocal() as db:
        try:
            ...
            await db.execute(text(
                ...
                "VALUES (:id, 'PF', 'Cliente Intake 4.2', :cpf, :email, 'ativo')"
            ...
            if filepath:
                ...
                full = f"{get_settings().UPLOAD_DIR}/{filepath}"
