from app.services.module_registry import MODULE_REGISTRY, gerar_mapa_modulos, listar_modulos, resumir_mapa_modulos
...
def test_module_registry_cobre_modulos_criticos():
    keys = {m["module_key"] for m in MODULE_REGISTRY}
    assert {"clientes", "casos", "documentos", "financeiro", "ia", "auditoria"}.issubset(keys)
