...
def test_migration_139_encadeia_em_138_e_e_o_head():
    ...
    # Banco Nacional de Teses V1 (22/08/2026): head canônico 147.
    assert script.get_heads() == ["147_banco_nacional_teses"]
    ...
    assert (
        script.get_revision("147_banco_nacional_teses").down_revision
