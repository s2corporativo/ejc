...
def test_migration_139_encadeia_em_138_e_e_o_head():
    ...
    # 153 de isolamento cliente-documento e a 154 (módulo de saneamento
    # processual, PROMPT 1) são as extensões aditivas desta branch.
    assert script.get_heads() == ["154_saneamento_schema"]
