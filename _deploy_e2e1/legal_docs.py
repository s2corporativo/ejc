...
async def exportar_pdf(
    ...
    # Peça IA sem revisão: PDF sai com tarja de rascunho no título
    titulo = d.titulo
    conteudo = d.conteudo
    if d.ai_generated and not d.human_reviewed:
        conteudo = ("> **⚠️ RASCUNHO GERADO POR IA — PENDENTE DE REVISÃO HUMANA "
                    "(Provimento OAB 205/2021). NÃO PROTOCOLAR.**\n\n") + conteudo
